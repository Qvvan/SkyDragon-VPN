        ...
        try:
            try:
                await message.bot.send_message(
                    referrer_id,
                    f"🐲 Ваш друг {'@' + message.from_user.username if message.from_user.username else ''} присоединился к кругу! Как только друг оплатит подписку, Древние драконы даруют вам бонус силы 🎁",
