...
LEXICON_RU: dict[str, str] = {
    ...
    "createorder": "<b>Наши услуги</b>\n\nВыберите тариф ниже.",
    "gift": "Выберите подписку для подарка — тарифы на кнопках ниже.",
    "purchase_thank_you": (
    ...
    "gift_recipient_auto": (
        ...
        "Пользователь {giver} подарил вам <b>{days}</b> дн. доступа — подписка уже начислена на ваш аккаунт.\n\n"
        "Откройте «Мои подписки» в меню, чтобы настроить подключение."
    ),
    "gift_sender_delivered": (
        "🎉 Ваш подарок доставлен: другу начислено <b>{days}</b> дн. подписки."
    ),
    "gift_already_credited": (
        "Этот подарок уже был зачислен на ваш аккаунт ранее."
    ),
    "add_gift_success": (
